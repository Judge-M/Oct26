...
def main():
    ...
    put(REPO / 'assets/large/desktop/silent-ridge-desktop-v1.qcow2.part001',
        'desktop/silent-ridge-desktop-v1.qcow2.part001', 'desktop')
    put(REPO / 'assets/large/desktop/silent-ridge-desktop-v1.qcow2.part002',
        'desktop/silent-ridge-desktop-v1.qcow2.part002', 'desktop')
